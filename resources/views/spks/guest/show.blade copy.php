<x-user-layout>
            ...
            <div class="bg-white  overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 ">
                    ...
                    <table class="table mt-1 w-full" border="1">
                        <thead>
                            <tr>
                                <th scope="col" class="px-6 py-3">Suhu (°C)</th>
                                <th>Kelembapan (%)</th>
                                <th>Drainase</th>
                                <th>Tekstur</th>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 ">
                    <h1 class="mb-6">Hasil Perhitungan Kecocokan Tanaman</h1>
                    <table class=" mt-1 w-full" border="1">
                        <thead>
                            <tr>
                                <th>Ranking</th>
                                <th>Nama Tanaman</th>
                        ...
                        <tbody>
                            ...
                            <tr class="text-center border-b">
                                <td>{{ $index + 1}}.</td>
                                <td class=" text-left">{{ $tanaman['nama']}}</td>
                                <td>{{ $tanaman['nilai']}}</td>
                            </tr>
                            @endforeach
                        </tbody>
    ...
    <div class="py-2">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white  overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 ">
                    <h1 class="mb-6">Matrix Normalisasi Nilai</h1>
                    <table class="table mt-1 w-full" border="1">
                        <thead>
                            <tr>
                                <th>No</th>
    ...
    <div class="py-2">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 ">
                    <h1 class="mb-6">Matrix Normalisasi Nilai * Pembobotan</h1>
                    <table class="table mt-1 w-full" border="1">
                        <thead>
                            <tr>
                                <th>No</th>
